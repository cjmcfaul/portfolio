...
class UpworkTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.job_feed = JobFeed.objects.create(
            ...
            assistant_id="asst_oAEQe0dErVQ8o4M5asaer7BK",
            assistant_instructions="You review job postings and let me know if I should apply. I'm a full stack developer and I know Django React Javascript HTML and CSS. I prefer to work on Minimum Viable Products. You only provide 'Yes' or 'No' responses"
        )
