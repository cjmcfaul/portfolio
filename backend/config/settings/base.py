...
# colin_mcfaul/frontend/
FRONTEND_DIR = PROJECT_DIR / "frontend"
# colin_mcfaul/backend/
BACKEND_DIR = PROJECT_DIR / "backend"
# colin_mcfaul/backend/apps/
...
if READ_DOT_ENV_FILE:
    ...
    env.read_env(str(BACKEND_DIR / ".env"))
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "apps.utils.context_processors.htmx_context",
            ],
        },
    }
]
...
ADMINS = [("""Colin McFaul""", "hi@colinmcfaul.com")]
